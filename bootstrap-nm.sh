...
export TGT=$(uname -m)-reap-linux-gnu
export LC_ALL=POSIX
...
sed -i 's/2.6.0/2.5.4/' ~/.cache/drag/stash/libtool/PKGBUILD
...
find $DRAG_ROOT/usr -depth -name $(uname -m)-reap-linux-gnu\* | xargs rm -rf
